...
export const CONFIG_SERVICE: Record<string, string> = {
  ...
  mail_enabled: "mail", mail_imap_host: "mail", mail_imap_port: "mail", mail_imap_ssl: "mail",
  mail_smtp_host: "mail", mail_smtp_port: "mail", mail_smtp_tls: "mail",
  mail_domain: "mail", mail_list_size: "mail",
