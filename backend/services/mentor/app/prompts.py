...
COMMON = (
    ...
    "- 답변은 반드시 '판정:' 한 줄로 시작합니다. 아래 셋 중 하나를 고르고, 정해진 개수만큼만 지적합니다.\n"
    "    · 판정: 충분  — 결론·수치·날짜가 모두 있음 → 고칠 점 0~1개\n"
    "    · 판정: 보통  — 일부만 있음                → 고칠 점 1~2개\n"
    "    · 판정: 미흡  — 대부분 빠짐                → 고칠 점 3개까지\n"
    "  '충분'인데 3개를 쓰면 잘못된 답입니다. 칸을 채우려고 지적을 만들지 마세요.\n"
